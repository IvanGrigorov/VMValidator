...
{
    public function __construct(public float $from, public float $to, protected ?string $errorMsg = null, protected ?string $customName = null, protected ?bool $nullable = false)
    {
