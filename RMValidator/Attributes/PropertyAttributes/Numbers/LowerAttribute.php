...
{
    public function __construct(public $lowerThan, protected ?string $errorMsg = null, protected ?string $customName = null)
    {
    ...
    public function validate(mixed $value) : void
    {
        ...
        if ($value >= $this->biggerThan) {
            throw new BiggerException($value, $this->lowerThan);
        }
    }
}