...
final class AllAttribute extends BaseAttribute implements IAttribute {
    ...
    public function __construct(public mixed $expected = null, protected ?string $errorMsg = null, protected ?string $customName = null, protected ?bool $nullable = false, protected ?string $name = null)
    {
