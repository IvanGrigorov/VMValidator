...
final class RegexAttribute extends BaseAttribute implements IAttribute
{
    ...
    public function __construct(public string $regex, protected ?string $errorMsg = null, protected ?string $customName = null, protected ?bool $nullable = false, protected ?string $name = null)
    {
