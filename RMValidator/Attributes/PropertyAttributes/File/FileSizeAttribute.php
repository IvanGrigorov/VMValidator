...
{
    public function __construct(public int $fileSizeLowest, public int $fileSizeBiggest, protected ?string $errorMsg = null, protected ?string $customName = null, protected ?bool $nullable = false)
    {
