...
{
    public function __construct(public int $fileSizeLowest, public int $fileSizeBiggest, protected ?string $errorMsg = null, protected ?string $customName = null, protected ?bool $nullable = false, protected ?string $name = null, protected ?int $severity = SeverityEnum::ERROR)
    {
