...
final class MemoryProfileAttribute extends BaseAttribute implements IAttribute, IProfileAttribute {
    ...
    public function __construct(public int $memFrom, public int $memTo, protected ?string $errorMsg = null, protected ?string $customName = null, protected ?bool $nullable = false, protected ?string $name = null, protected ?string $severity = SeverityEnum::ERROR)
    {
